...
;($ => {
        ...
        $(this)
          ...
          .show({
            ...
            complete: function () {
              ...
              $('html, body').animate({scrollTop: $(this).parent().offset().top - fixHeaderHeight}, 300)
            }
          })
      } else {
  ...
  function identificationService() {
    ...
    function checkValidInput() {
      ...
      if (!isValid) {
        formStep.find('.btn-next').css({'pointer-events': 'none', opacity: 0.6})
      } else {
        formStep.find('.btn-next').css({'pointer-events': 'inherit', opacity: 1})
      }
    }
